...
## 🚀 Fitur Utama
*   **Smart DO-based Auto Feeding:** Pemberian pakan otomatis berdasarkan ambang batas sensor *Dissolved Oxygen* (DO) yang dilengkapi sistem *Cooldown* (jeda 2 jam) untuk mencegah *overfeeding* dan pembusukan pakan.
